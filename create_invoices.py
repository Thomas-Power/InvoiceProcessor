...
if __name__ == '__main__':
	...
	for customer in customers.find():
		...
		os.makedirs(os.path.dirname('.\\Invoices\\'  + str(month) + "-" + str(year)[2:] + "\\"), exist_ok=True)
		wbook.save('.\\Invoices\\'  + str(month) + "-" + str(year)[2:] + "\\" + str(customer["customer_no"]) + "- " + customer["name"] + ".xlsx")
	
	print("[PYTHON]: Process complete, invoices generated for " + str(month) + "-" + str(year))
	sys.stdout.flush()
